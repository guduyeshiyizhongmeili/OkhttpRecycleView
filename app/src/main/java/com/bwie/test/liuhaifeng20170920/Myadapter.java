...
public class Myadapter extends RecyclerView.Adapter{
    ...
    public Myadapter(Context mcontext,ArrayList<News.StoriesBean> list) {
    ...
    //手写的重置数据的方法
    public void setdata(ArrayList<News.StoriesBean> list){
    ...
    //手写的获得视图的方法
    public News.StoriesBean getItem(int position){
